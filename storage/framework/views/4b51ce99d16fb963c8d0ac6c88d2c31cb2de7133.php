...
<div class="wrapper">
  ...
  <div class="container-fluid">
      ...
      <div class="col-md-12">
        <div class="card-box formCard">
          ...
          <?php echo $__env->make('layouts/itinerary_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php if($day <= $departure->no_of_days): ?>
                    ...
                    <div class="row">
                      <div class="col-md-2 col-lg-2 col-xl-2 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="day" id="day" value="<?php echo e(array_shift($day_number)); ?>" readonly="">
                        </div>
                      </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <?php echo $__env->make('departure/itinerary_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
    </div>
    <style type="text/css">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 col-xl-12">
                  ...
                  <label>Destinations</label><span class="validationError" id="edit_destinations_error"></span><br>
                    <select class="form-control" name="edit_destinations[]" id="edit_destinations" multiple="">
                      <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $desti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($desti->id); ?>"><?php echo e($desti->dest_name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                </div>
    ...
    $(document).ready(function () {
      $('#store_form').click(function (e) {
        ...
        $.ajax({
          ...
          method: 'POST',
          url: "<?php echo e(route('itinerary_store', request()->route('id'))); ?>",
          data: formDatas,
          contentType: false,
          processData: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/departurecloud/resources/views/departure/itinerary_create.blade.php ENDPATH**/ ?>