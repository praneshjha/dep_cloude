                            ...
                            <div class="demo-form">
                                <form method="POST" id="demoForm">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="timeSlot">Preferable Time</label>
                                                <span class="validationError" id="timeSlot_error"></span>
                                                <select class="form-control" autocomplete="off" name="time" id="timeSlot">
                                                    <option value="" selected="">Preferable Time</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="daySlot">Preferable Day</label>
                                                <select class="form-control" autocomplete="off" name="day" id="daySlot">

                                                    <option value="" selected="">Preferable Day</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('websitelayoute.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/departure/resources/views/demo.blade.php ENDPATH**/ ?>