<?php $__env->startSection('title', 'How DepartureCloud Works for Travel Suppliers & Buyers'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="banner-20 pos-rel oh bg_img" data-background="<?php echo e(asset('website/images/extra-2/banner/banner-bg-20.jpg')); ?>">
        <div class="container">
            <div class="row flex-wrap-reverse align-items-center justify-content-lg-between">
                <div class="col-lg-5">
                    <div class="banner-thumb-20 rtl">
                        <img src="<?php echo e(asset('website/images/feature/faster.png')); ?>" alt="extra-2/banner" style="transform: scaleX(-1);">
                        <!-- <img src="<?php echo e(asset('website/images/extra-2/banner/banner-20.png')); ?>" alt="extra-2/banner">
                    ...
                    <div class="cola-item">
                        ...
                        <div class="col-md-6">
                            <div class="cola-thumb">
                                <img src="<?php echo e(asset('website/images/feature/advance6.png')); ?>" alt="feature" style="transform: scaleX(-1);">
                            </div>
                        </div>
                    </div>
                    <div class="cola-item">
                        ...
                        <div class="col-md-6">
                            <div class="cola-thumb">
                                <img src="<?php echo e(asset('website/images/feature/advance6.png')); ?>" alt="feature">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('websitelayoute.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/departure/resources/views/how_it_works.blade.php ENDPATH**/ ?>