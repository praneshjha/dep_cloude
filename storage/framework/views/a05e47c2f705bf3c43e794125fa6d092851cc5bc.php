                           ...
                           <div class="row">
                                <div class="col-md-11 ml-2">
                                    <div class="form-group">
                                      <input type="hidden" name="id" value="<?php echo e($term_master->id); ?>">
                                       <label for="email"><br>Terms & Conditions Master:</label>
                                        <textarea class="form-control" name="terms_master" id="terms_master"><?php echo $term_master->conditions; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
 ...
 $(document).ready(function () {
    $('#store_form').click(function (e) {
        ...
        $.ajax({
            ...
            method: 'POST',
            url: "<?php echo e(route('term_master_update')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/departurecloud/resources/views/terms/terms_master_edit.blade.php ENDPATH**/ ?>