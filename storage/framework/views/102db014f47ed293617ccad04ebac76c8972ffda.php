                                    ...
                                    <div class="form-group">
                                        <label for="profession">Username</label>
                                         <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control" id="user_name" name="user_name" value="<?php echo e(($smtp_data->user_name)); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <label for="profession">Password</label>
                                         <div class="input-group date">
                                            ...
                                            <input type="password" class="form-control" id="password" name="password" value="<?php echo e($smtp_data->password); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <label for="profession">Port</label>
                                         <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control" id="port" name="port" value="<?php echo e(($smtp_data->port)); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="profession">Host</label>
                                         <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control" id="host" name="host" value="<?php echo e(($smtp_data->host)); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="profession">From Email</label>
                                         <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control" id="from_mail" name="from_mail" value="<?php echo e(($smtp_data->from_mail)); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="profession">From Name</label>
                                         <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control" id="from_name" name="from_name" value="<?php echo e(($smtp_data->from_name)); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="profession">Reply To</label>
                                         <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control" id="reply_to" name="reply_to" value="<?php echo e(($smtp_data->reply_to)); ?>">
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/departurecloud/resources/views/profile/index.blade.php ENDPATH**/ ?>