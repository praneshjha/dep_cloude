        ...
        <?php endif; ?>
            <div class="mb-21 ">
                ...
                <?php if($departure->fav_pkg == 1): ?>
                    <i class='mdi mdi-heart' data-toggle="tooltip" data-placement="top" title="Unfavourite Package" onClick="getPkgIDs_Del(<?php echo e($departure->id); ?>)" id="favPkgDel<?php echo e($departure->id); ?>" style="font-size: 16px;color:blue;"></i>
                <?php else: ?>
                    <i class='mdi mdi-heart' data-toggle="tooltip" data-placement="top" title="Favourite Package" onClick="getPkgIDs(<?php echo e($departure->id); ?>)" id="favPkgIn<?php echo e($departure->id); ?>" style="font-size: 16px;"></i>
                <?php endif; ?>
                </div>
                <p class="mb-0">
                    <a href="<?php echo e(url('profile/'.$departure->company_url)); ?>" class="userprofileName"><?php echo e($departure->departure_ownner); ?></a>&nbsp;
                        ...
                        <?php if($departure->fav_sapplier == 1): ?>
                            <i class="mdi mdi-heart favourite_icon" data-toggle="tooltip" data-placement="top" title="Unfavourite Supplier" aria-hidden="true" id="fav_icon<?php echo e($departure->dep_id); ?>" onClick='getSupId_Del(<?php echo e($departure->dep_id); ?>)' style="color:red;" id="favDel"></i>
                        
                        <?php else: ?>
                            <i class="mdi mdi-heart favourite_icon" data-toggle="tooltip" data-placement="top" title="Favourite Supplier" aria-hidden="true" id="fav_icon<?php echo e($departure->dep_id); ?>" onClick='getSupId(<?php echo e($departure->dep_id); ?>)' id="favSave"></i>
                        <?php endif; ?>
...
<div class="modal fade" id="hold_modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        ...
        <?php /**PATH /var/www/departure/resources/views/dashboard/data.blade.php ENDPATH**/ ?>