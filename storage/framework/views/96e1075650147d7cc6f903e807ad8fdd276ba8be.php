...
<?php $__env->startSection('title', 'Worldwide Travel & Fixed Departures Management - DepartureCloud'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="banner-7 bg_img oh bottom_right" data-background="<?php echo e(asset('website/images/banner/banner-bg-7.jpg')); ?>">
        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="banner-content-7">
                        ...
                        <div class="banner-button-group">   
                            <a href="<?php echo e(route('register')); ?>" class="button-4">Register Now</a>
                            <a href="<?php echo e(route('login')); ?>" class="button-4 active">Log In</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-lg-block d-none">
                    <img src="<?php echo e(asset('website/images/banner/banner-7.png')); ?>" alt="banner">
                </div>
                <div class="col-12">
                    <div class="counter-wrapper-3">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="<?php echo e(asset('website/images/icon/counter1.png')); ?>" alt="icon">
                            </div>
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="<?php echo e(asset('website/images/icon/counter2.png')); ?>" alt="icon">
                            </div>
                            <div class="counter-content">
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="<?php echo e(asset('website/images/icon/counter5.png')); ?>" alt="icon">
                            </div>
                            <div class="counter-content">
    ...
    <section class="to-access-section padding-top padding-bottom bg_img mb-lg-5" data-background="<?php echo e(asset('website/images/feature/to-access-bg.png')); ?>" id="feature">
        <div class="container">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="to-access-item">
                        <div class="to-access-thumb">
                            ...
                            <div class="thumb">
                                <img src="<?php echo e(asset('website/images/icon/access1.png')); ?>" alt="access">
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="to-access-item active">
                        <div class="to-access-thumb">
                            <span class="anime"></span>
                            <div class="thumb">
                                <img src="<?php echo e(asset('website/images/icon/access2.png')); ?>" alt="access">
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="to-access-item">
                        <div class="to-access-thumb">
                            <span class="anime"></span>
                            <div class="thumb">
                                <img src="<?php echo e(asset('website/images/icon/access3.png')); ?>" alt="access">
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="to-access-item">
                        <div class="to-access-thumb">
                            <span class="anime"></span>
                            <div class="thumb">
                                <img src="<?php echo e(asset('website/images/icon/access4.png')); ?>" alt="access">
                            </div>
                        </div>
    ...
    <section class="work-section padding-bottom bg_img mb-md-95 pb-md-0" data-background="<?php echo e(asset('website/images/work/work-bg.jpg')); ?>" id="how">
        <div class="oh padding-top pos-rel">
            <div class="top-shape d-none d-lg-block">
                <img src="<?php echo e(asset('website/css/img/work-shape.png')); ?>" alt="css">
            </div>
            <div class="container">
                <div class="row">
                ...
                <div class="work-slider owl-carousel owl-theme" data-slider-id="2">
                    <div class="work-item">
                        <div class="work-thumb">
                            <img src="<?php echo e(asset('website/images/work/work1.png')); ?>" alt="work">
                        </div>
                        <div class="work-content cl-white">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="get-button white light">Get Started <i class="flaticon-right"></i></a>
                        </div>
                    </div>
                    <div class="work-item">
                        <div class="work-thumb">
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-4 col-xl-3 rtl d-none d-lg-block">
                    <img src="<?php echo e(asset('website/images/access/access1.png')); ?>" alt="access">
                </div>
                <div class="col-lg-8">
                    <div class="access-content">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="get-button">get started <i class="flaticon-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="pos-rel mw-100">
                        <img class="w-100" src="<?php echo e(asset('website/images/feature/feature-video-1.png')); ?>" alt="bg">
        ...
        <div class="container">
            <div class="advance-feature-item padding-top-2 padding-bottom-2">
                <div class="advance-feature-thumb">
                    <img src="<?php echo e(asset('website/images/feature/advance1.png')); ?>" alt="feature">
                </div>
                <div class="advance-feature-content">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="get-button">get started now <i class="flaticon-right"></i></a>
                </div>
            </div>
            <div class="advance-feature-item padding-top-2 padding-bottom-2">
                <div class="advance-feature-thumb">
                    <img src="<?php echo e(asset('website/images/feature/advance2.png')); ?>" alt="feature">
                </div>
                <div class="advance-feature-content">
                    <div class="section-header left-style mb-olpo">
    ...
    <section class="pricing-section padding-top oh padding-bottom pb-lg-half bg_img pos-rel" data-background="<?php echo e(asset('website/images/bg/pricing-bg.jpg')); ?>" id="pricing">
        <div class="top-shape d-none d-md-block">
            <img src="<?php echo e(asset('website/css/img/top-shape.png')); ?>" alt="css">
        </div>
        <div class="bottom-shape d-none d-md-block mw-0">
            <img src="<?php echo e(asset('website/css/img/bottom-shape.png')); ?>" alt="css">
        </div>
        <div class="ball-2" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
        data-paroller-type="foreground" data-paroller-direction="horizontal">
            <img src="<?php echo e(asset('website/images/balls/1.png')); ?>" alt="balls">
        </div>
        <div class="ball-3" data-paroller-factor="0.30" data-paroller-factor-lg="-0.30"
        data-paroller-type="foreground" data-paroller-direction="horizontal">
            <img src="<?php echo e(asset('website/images/balls/2.png')); ?>" alt="balls">
        </div>
        <div class="ball-4" data-paroller-factor="0.30" data-paroller-factor-lg="-0.30"
        data-paroller-type="foreground" data-paroller-direction="horizontal">
            <img src="<?php echo e(asset('website/images/balls/3.png')); ?>" alt="balls">
        </div>
        <div class="ball-5" data-paroller-factor="0.30" data-paroller-factor-lg="-0.30"
        data-paroller-type="foreground" data-paroller-direction="vertical">
            <img src="<?php echo e(asset('website/images/balls/4.png')); ?>" alt="balls">
        </div>
        <div class="ball-6" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
        data-paroller-type="foreground" data-paroller-direction="horizontal">
            <img src="<?php echo e(asset('website/images/balls/5.png')); ?>" alt="balls">
        </div>
        <div class="ball-7" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
        data-paroller-type="foreground" data-paroller-direction="vertical">
            <img src="<?php echo e(asset('website/images/balls/6.png')); ?>" alt="balls">
        </div>
        <div class="container">
            ...
            <div class="pricing-slider-wrapper mt-0">
                <div class="d-md-flex justify-content-center">
                    <div class="pricing-item-2 col-lg-3 mb-3 mb-md-0">
                        ...
                        <div class="thumb">
                            <img src="<?php echo e(asset('website/images/buyer.png')); ?>" alt="pricing">
                        </div>
                    ...
                    <div class="pricing-item-2 col-lg-3 mb-3 mb-md-0">
                        ...
                        <div class="thumb">
                            <img src="<?php echo e(asset('website/images/supplier.png')); ?>" alt="pricing">
                        </div>
        ...
        <div class="container">
            ...
            <div class="testimonial-wrapper">
                <a href="#0" class="testi-next trigger">
                    <img src="<?php echo e(asset('website/images/client/left.png')); ?>" alt="client">
                </a>
                <a href="#0" class="testi-prev trigger">
                    <img src="<?php echo e(asset('website/images/client/right.png')); ?>" alt="client">
                </a>
                <div class="testimonial-area testimonial-slider owl-carousel owl-theme">
                    <div class="testimonial-item">
                        <div class="testimonial-thumb">
                            <div class="thumb">
                                <img src="<?php echo e(asset('website/images/client/client1.jpg')); ?>" alt="client">
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="faq-header">
                        <div class="cate">
                            <img src="<?php echo e(asset('website/images/cate.png')); ?>" alt="cate">
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('websitelayoute.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\departurecloud\resources\views/welcome.blade.php ENDPATH**/ ?>