<?php $__env->startSection('title', 'Cancelation chage - Departure Cloud'); ?>
                    ...
                    <?php echo $__env->make('layouts/itinerary_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                      <form action="" method="post" id="paymensechdule">
                           ...
                           <div class="row" >
                              ...
                              <?php $__currentLoopData = $cancel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($key == 0): ?>
                                  <div class="row ">
                                    <div class="col-md-3" style="margin-top:25px" id="remove_date<?php echo e($key); ?>">
                                    ...
                                    <div class="col-md-3 ml-1" id="remove_percentage<?php echo e($key); ?>">
                                        <div class="form-group">
                                            <label for="">Percentage(%)</label>
                                            <input type="text" class="form-control percentage percentages<?php echo e($key); ?>"  id="percentage2" name="percentage[]" value="<?php echo e($row->percentage); ?>"  required>
                                            <span class="text-danger" id="percentage_error2"></span>
                                        </div>
                                    </div>
                                    <div class="" style="margin-top: 1.4rem!important; margin-left: 5px;" id="remove_buttons<?php echo e($key); ?>">
                                        <div class="form-group">
                              ...
                              <?php endif; ?>
                                <div class="row ">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="">After</label>
                                             <div class="input-group date">
                                                ...
                                                <span class="text-danger" id="calender_error<?php echo e($key); ?>"></span>
                                             </div>
                                    ...
                                    <div class="col-md-3" id="remove_percentage<?php echo e($key); ?>">
                                        <div class="form-group">
                                            <label for="">Percentage(%)</label>
                                            <input type="text" class="form-control percentage percentages<?php echo e($key); ?>"  id="percentage<?php echo e($key); ?>" name="percentage[]" value="<?php echo e($row->percentage); ?>">
                                        </div>
                                        <span class="text-danger" id="percentage_error<?php echo e($key); ?>"></span>
                                    </div>
                                    <div class="" style="margin-top: 1.4rem!important; margin-left: 5px;" id="remove_buttons<?php echo e($key); ?>">
                                        <div class="form-group">
                                             <a  class="btn btn-outline-danger text-danger" id="remove_input<?php echo e($key); ?>"><i class="fas fa-minus"> Remove</i></a>
                          ...
                          <div class="row">  
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12 mt-3 text-right">
                                    <img src="<?php echo e(asset('images/loader.gif')); ?>" id="gif" style="width: 8%; visibility: hidden;">
...
<?php $__currentLoopData = $cancel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
$('.percentages<?php echo e($key); ?>').keyup(function(){
      if($(this).val() > 100){
        $(this).val('');
      }else{
        $('.percentages<?php echo e($key); ?>').text('');
      }
   });
var percentage = document.querySelector('.percentages<?php echo e($key); ?>');
   ...
   jQuery(document).ready(function () {
       jQuery('#store_form').click(function (e) {
           ...
           //alert('hello');percentage
            <?php $count=0; ?>
            <?php $__currentLoopData = $cancel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            var After = $('#start_date<?php echo e($key); ?>').val();
               if (After == "") {
                   $("span#calender_error<?php echo e($key); ?>").html('This field is required!');
                   $("input#start_date<?php echo e($key); ?>").focus();
                   return false;
               }else{
                   $("span#calender_error<?php echo e($key); ?>").hide();
               }
            var percentage = $('#percentage<?php echo e($key); ?>').val();
               if (percentage == "") {
                   $("span#percentage_error<?php echo e($key); ?>").html('This field is required!');
                   $("input#percentage<?php echo e($key); ?>").focus();
                   return false;
               }else{
                   $("span#percentage_error<?php echo e($key); ?>").hide();
               }
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php for( $count = 1; $count < 11; $count++): ?>
            var calender_<?php echo e($count); ?> = $('.calender_<?php echo e($count); ?>').val();
                if (calender_<?php echo e($count); ?> == "") {
                   $("span#calender_error_<?php echo e($count); ?>").html('This field is required!');
                   $("select#calender_<?php echo e($count); ?>").focus();
                   return false;
                }else{
                   $("span#calender_error_<?php echo e($count); ?>").hide();
                }
            var percentage_<?php echo e($count); ?> = $('#percent_<?php echo e($count); ?>').val();
                if (percentage_<?php echo e($count); ?> == "") {
                   $("span#percent_error_<?php echo e($count); ?>").html('This field is required!');
                   $("select#percent_<?php echo e($count); ?>").focus();
                   return false;
                }else{
                   $("span#percent_error_<?php echo e($count); ?>").hide();
                }
            <?php endfor; ?>
           jQuery('#gif').show();
           ...
           jQuery.ajax({
               ...
               method: 'POST',
               url: "<?php echo e(route('cancelation_update',request()->route('id'))); ?>",
               data: formDatas,
               contentType: false,
               processData: false,
...
$('#remove_input<?php echo e($key); ?>').click(function(){
   ...
   $('#start_date<?php echo e($key); ?>').datepicker({
    ...
    dateFormat: 'dd-M-yy',
    maxDate: new Date('<?php echo e($departure->start_date); ?>'),
    minDate: 0,
  });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/departurecloud/resources/views/cancelation/edit.blade.php ENDPATH**/ ?>