Dear <b><?php echo e($fname); ?> <?php echo e($lname); ?></b>
<p>You have received request to book <?php echo e($book_seat); ?> units in your departure.</p>
...
<p><b>Buyer Company Name: </b> <?php echo e(auth()->user()->company_name); ?></p>
<p><b>Booked Request By:</b> <?php echo e(auth()->user()->name); ?> <?php echo e(auth()->user()->last_name); ?></p>
...
<?php /**PATH /var/www/html/departurecloud/resources/views/mail/supplier_book_departure_mail_new.blade.php ENDPATH**/ ?>