<?php $__env->startSection('title', 'Departure Management Platform - About Departure Cloud'); ?>
...
<!--============= Header Section Ends Here =============-->
    <section class="page-header bg_img" data-background="<?php echo e(asset('website/images/page-header.png')); ?>">
            ...
            <div class="row align-items-center">
                <div class="col-xl-5">
                    <div class="about-thumb rtl pr-xl-15">
                        <img src="<?php echo e(asset('website/images/about/about.png')); ?>" alt="about">
                    </div>
                </div>
                        ...
                        <div class="counter-area-5">
                            <div class="counter-item-5">
                                <div class="counter-thumb">
                                    <img src="<?php echo e(asset('website/images/counter/counter1.png')); ?>" alt="counter">
                                </div>
                            ...
                            <div class="counter-item-5">
                                <div class="counter-thumb">
                                    <img src="<?php echo e(asset('website/images/counter/counter2.png')); ?>" alt="counter">
                                </div>
                                <div class="counter-content">
                            ...
                            <div class="counter-item-5">
                                <div class="counter-thumb">
                                    <img src="<?php echo e(asset('website/images/counter/counter3.png')); ?>" alt="counter">
                                </div>
                                <div class="counter-content">
    ...
    <section class="oh creativity-section padding-bottom bg-max-lg-dark bg_img top_center" data-background="<?php echo e(asset('website/images/feature/experience-bg.png')); ?>">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-6 col-xl-4 d-none d-lg-block">
                    <img src="<?php echo e(asset('website/images/feature/experience.png')); ?>" alt="feature">
                </div>
            </div>
        </div>
    </section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('websitelayoute.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/departure/resources/views/aboutus.blade.php ENDPATH**/ ?>