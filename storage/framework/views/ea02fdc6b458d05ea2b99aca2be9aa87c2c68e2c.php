<?php $__env->startSection('title', 'Departure Cloud Pricing Plans For Suppliers & Buyers'); ?>
...
<!--============= About Section Starts Here =============-->
	<section class="page-header single-header bg_img oh" data-background="./assets1/images/page-header.png" style="background-image: url(<?php echo e(asset('assets1/images/page-header.png')); ?>);">
        <div class="bottom-shape d-none d-md-block">
            <img src="<?php echo e(asset('website/css/img/page-header2.png')); ?>" alt="css">
        </div>
    </section>
                		...
                		<div class="pricing-slider-wrapper">
                			<div class="pricing-slider owl-theme owl-carousel owl-loaded owl-drag">
                				<div class="pricing-item-2">
                                    <h5 class="cate">Buyer</h5>
		                            <div class="thumb">
		                                <img src="<?php echo e(asset('website/images/pricing/pricing1.png')); ?>" alt="pricing">
		                            </div>
                                ...
                                <div class="pricing-item-2">
                                	<h5 class="cate">Supplier</h5>
		                            <div class="thumb">
		                                <img src="<?php echo e(asset('website/images/pricing/pricing2.png')); ?>" alt="pricing">
		                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('websitelayoute.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/departure/resources/views/pricing.blade.php ENDPATH**/ ?>