          ...
          <div class="popup" id="popup">
            ...
            <div class="card p-3">
              <form class="searchPage">
                ...
                <?php $__currentLoopData = $destinationFind; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $findDepa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="upcoming">
                   <div class="secDiv">
                       <a href='<?php echo e(url("dashboard")); ?>?type=11&keyword=<?php echo e($findDepa->dest_name); ?>'>#<?php echo e($findDepa->dest_name); ?></a>
                    </div>
                  </div>
...
<script>
  ...
  function getSupId(id){
    ...
    console.log(dep_id);
    $.ajax({
      url:"<?php echo e(route('favouriteSup')); ?>",
      method:"GET",
      data:{dep_id:dep_id},
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\departurecloud\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>