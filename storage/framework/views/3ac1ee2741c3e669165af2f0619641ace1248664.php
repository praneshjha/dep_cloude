                        ...
                        <form role="form" id="DeparturForm">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12 col-sm-12 mb-2">
                                    <h4 class="m-0"><?php echo e($departures->departure_type); ?></h4>
                                    <div class="underline"></div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        <?php if($departures->departure_type == 'Flight Only'): ?>
                                        ...
                                        <?php endif; ?>
                                        <input type="text" class="form-control" name="title" id="title" value="<?php echo e($departures->title); ?>" placeholder="4 Nights 5 Days Pharaohs Nile Cruise Adventure">
                                ...
                                <?php if(in_array(3, json_decode($columns))): ?>
                                        ...
                                        <div class="d-flex">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="nights" id="nights" placeholder="4" value="<?php echo e($departures->no_of_nights); ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="days" placeholder="4" id="days" value="<?php echo e($departures->no_of_days); ?>">
                                                    <div class="input-group-append">
                                ...
                                <div class="col-md-2 col-lg-2 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="total_seat" id="total_seat" placeholder="Total no. seat available" value="<?php echo e($departures->total_seat); ?>">
                                ...
                                <input type="hidden" class="form-control" name="total_room" id="total_room" placeholder="Total rooms available" value="<?php echo e($departures->total_room); ?>">
                                <!-- <span class="validationError" id="total_room_error"></span>
                            </div>
                        </div> -->
                                <div class="col-md-2 col-lg-2 col-sm-12">
                                    <div class="form-group">
                                        <label for="start_date" id="start_date_lebel"><?php if($departures_types->departure_type == 2): ?>
                                                Start Date
                                            <?php elseif($departures_types->departure_type == 4): ?>
                                                Chek-In Date
                                            <?php else: ?>
                                                Departure Date
                                            <?php endif; ?> <span class="text-danger">*</span></label>
                                        <div class="input-group date">
                                            <input type="text" class="form-control pull-right start_date fromdate" name="start_date" id="start_date" placeholder="Tour Start Date" value="<?php echo e(date('d M Y', strtotime($departures->start_date))); ?>">
                                ...
                                <div class="col-md-2 col-lg-2 col-sm-12">
                                    <div class="form-group">
                                        <label for="return_date" id="return_date_lebel"><?php if($departures_types->departure_type == 2): ?>
                                                End Date
                                            <?php elseif($departures_types->departure_type == 4): ?>
                                                Check-Out Date
                                            <?php else: ?>
                                            ...
                                            <?php endif; ?></label>
                                        <div class="input-group date">
                                            <?php if($departures->end_date != null): ?>
                                                <input type="text" class="form-control pull-right retrun_date todate" name="return_date" id="return_date" autocomplete="off" value="<?php echo e(date('d M Y', strtotime($departures->end_date))); ?>"
                                ...
                                <div class="col-md-2 col-lg-2 col-sm-12">
                                    <div class="form-group">
                                        <?php if($departures_types->departure_type == 2): ?>
                                        ...
                                        <select class="form-control  hotel" name="ending_at" id="ending_at">
                                            <option value="<?php echo e($departures->ending_at); ?>" selected><?php echo e($departures->ending_at); ?></option>

                                        </select>
                                        <span class="validationError" id="ending_at_error"></span>
                                    </div>
                                </div>
                                <?php if(in_array(10, json_decode($columns))): ?>
                                    <div class="col-md-3 col-lg-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control hotel" name="starting_from[]" id="starting_from" multiple>
                                                <?php $__currentLoopData = $departures->end_at; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $endingAt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($endingAt); ?>" selected><?php echo e($endingAt); ?></option>
                                    ...
                                    <div class="col-md-3 col-lg-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control hotel" name="return_to[]" id="return_to" multiple>
                                                <?php $__currentLoopData = $departures->return_to; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $returnTo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($returnTo); ?>" selected><?php echo e($returnTo); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                ...
                                <div class="col-md-2 col-lg-2 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control hold_duration" name="hold_time" id="hold_duration">
                                            <?php $__currentLoopData = $holdduration; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($row->hours); ?>" <?php if($departures->hold_duration == $row->hours): ?> selected <?php else: ?> <?php endif; ?>><?php echo e($row->hours); ?> Hours</option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-2 col-lg-2 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control holdtill" name="hold_duration" id="holdtill" onclick='showDays()'>
                                            ...
                                            <?php if(count($holdtill)>0): ?>
                                                <?php $__currentLoopData = $holdtill; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->days); ?>" <?php if($departures->holdDep == $row->days): ?> selected <?php endif; ?>> D-<?php echo e($row->days); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control w-100" name="contact_person" id="contact_person">
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $use): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($use->id); ?>" <?php if($use->id == $departures->contact_person_id): ?> selected <?php endif; ?>><?php echo e($use->flname); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <input type="hidden" class="form-control" name="ownner" id="ownner" value="<?php echo e($departures->company_name); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-3 col-lg-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control w-100" name="additional_person_id" id="additional_person_id">
                                                ...
                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $use): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($use->id); ?>" <?php if($use->id == $departures->additional_person_id): ?> selected <?php endif; ?>><?php echo e($use->flname); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" id="description" rows="3" palaceholder=""><?php echo e($departures->description); ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 button-submit1 ml-auto">
                                    <img src="<?php echo e(asset('images/loader.gif')); ?>" id="gif" style="width: 15%; visibility: hidden;">
                                ...
                                <div class="col-md-2 button-submit1">
                                    <img src="<?php echo e(asset('images/loader.gif')); ?>" id="gif1" style="width: 15%; visibility: hidden;">
        ...
        $(document).ready(function () {
            $('#store_form').click(function (e) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "<?php echo e(route('departure_update',request()->route('id'))); ?>",
                    data: formDatas,
                    contentType: false,
                    processData: false,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/departurecloud/resources/views/departure/basic_details_edit.blade.php ENDPATH**/ ?>