@extends('layouts.app')
@section('tagSection')
<title>Suppliers List | Departure Cloud</title>
@endsection
@section('content')
                            ...
                            <div class="col-12 mb-2">
                                <nav>
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item"><a href="{{route('user_booking',$id)}}" class="nav-link active">Booked</a></li>
                                        <li class="nav-item"><a href="{{route('user_holding',$id)}}" class="nav-link"> Hold </a></li>
                                    </ul>
                                </nav>
                            </div>
                            <div class="col-md-12">
                                    ...
                                    <table id="" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <td><a href="{{route('departure_booking_history_details',$row->unique_id)}}"><i class="fa fa-eye" title="Booking Details"></i></a></td>
                                             </tr>
                                             @endforeach
                                            </tbody>
                                    </table>
