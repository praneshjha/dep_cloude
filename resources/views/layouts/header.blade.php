        ...
        <div class="container-fluid">
            <ul class="list-unstyled topnav-menu float-right mb-0">
                ...
                {{--<li class="d-block dropdown">
                    <a href="javascript:void(0);" class="app-search " id="header_search"><span class="app-search-box"><i class="fe-search"></i></span></a>
                ...
                <li class="dropdown profiledropdowntop notification-list ">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown"  aria-labelledby="dc_admin_drop1">
                        ...
                        @endif
                        <a href="{{route('chat_room')}}" class="dropdown-item notify-item">
                            <i class="far fa-comment-dots"></i>
                            <span>Chat</span>
                        </a>
                        <a href="{{route('role')}}" class="dropdown-item notify-item">
                            <i class="fe-user"></i>
                        ...
                        <a href="{{route('index_mailer')}}" class="dropdown-item notify-item">
                            <i class="fe-lock"></i>
                            <span>Mailer Shoot</span>
                        </a>
                        @endif
                        @if(auth()->user()->tenant_id == 'jwkpdcqmlez1648799148')
                        <a href="{{route('countries')}}" class="dropdown-item notify-item">
            ...
            <div id="navigation" class="d-lg-flex">
                <ul class="navigation-menu">
                    @if(Auth::user()->main_user_type == 0)
                        <li class="">
                            <a href="{{route('dashboard')}}" class="@if(Route::currentRouteName() == 'dashboard') active @endif"><i class="fe-airplay"></i>Departures</a>
                        </li>
                        <li class="">
                    ...
                    @elseif(Auth::user()->main_user_type == 1)
                        <li class="">
                            <a href="{{route('dashboard')}}" class="@if(Route::currentRouteName() == 'dashboard') active @endif"><i class="fe-airplay"></i>All Departures</a>
                        </li>
                        <li>
    ...
    <div class="box_model">
      ...
      <div class="logo_container d-flex justify-content-between py-3">
        <div class="d-flex align-items-center">
          <div class="logo_img">
            <img src="{{ asset('images/pullit-logo.png')}}" alt="logo" class="img-fluid">
          </div>
          <h1>Pullit</h1>
        </div>
        <div>
          {{--<a href="javascript:void(0);" title="Report"><i class="mdi mdi-alert-octagon text-white"></i></a>
          <a href="javascript:void(0);" title="Feedback"><i class="mdi mdi-comment-quote-outline text-white mx-3"></i></a>--}}
