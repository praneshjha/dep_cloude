...
<script src="{{asset('assets1/libs/multiselect/jquery.multi-select.js')}}"></script>
<script src="{{asset('assets1/libs/select2/select2.min.js')}}"></script>
<script src="{{asset('assets1/libs/jquery-mockjax/jquery.mockjax.min.js')}}"></script>
<script src="{{asset('assets1/libs/autocomplete/jquery.autocomplete.min.js')}}"></script>
<script src="{{asset('assets1/libs/bootstrap-select/bootstrap-select.min.js')}}"></script>

<script src="{{asset('assets1/libs/datatables/jquery.dataTables.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/dataTables.bootstrap4.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/dataTables.responsive.min.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/responsive.bootstrap4.min.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/dataTables.buttons.min.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/buttons.bootstrap4.min.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/buttons.html5.min.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/buttons.flash.min.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/buttons.print.min.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/dataTables.keyTable.min.js')}}"></script>
<script src="{{asset('assets1/libs/datatables/dataTables.select.min.js')}}"></script>
<script src="{{asset('assets1/libs/pdfmake/pdfmake.min.js')}}"></script>
<script src="{{asset('assets1/libs/pdfmake/vfs_fonts.js')}}"></script>
...
<script src="{{asset('assets1/js/dc_script.js')}}"></script>
...
// pullit Js
  ...
  var pulItUrl = "https://pullit.watconsultingservices.com/";
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $.ajax({
            ...
            type:"post",
            url: "{{route('pullIt_destination_data')}}",
