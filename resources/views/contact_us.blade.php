...
@section('title', 'Contact Us - Departure Cloud')
@section('metas')
...
<!--============= Header Section Ends Here =============-->
    <section class="page-header single-header bg_img oh" data-background="{{asset('website/images/page-header.png')}}">
                ...
                <div class="col-lg-4">
                    <div class="contact-content">
                        <div class="man d-lg-block d-none">
                            <img src="{{asset('website/images/contact/man.png')}}" alt="bg">
                        </div>
                        ...
                        <div class="contact-area">
                            <div class="contact-item">
                                <div class="contact-thumb">
                                    <img src="{{asset('website/images/contact/contact1.png')}}" alt="contact">
                                </div>
                            ...
                            <div class="contact-item">
                                <div class="contact-thumb">
                                    <img src="{{asset('website/images/contact/contact2.png')}}" alt="contact">
                                </div>
                                <div class="contact-contact">
                            ...
                            <div class="contact-item">
                                <div class="contact-thumb">
                                    <img src="{{asset('website/images/contact/contact3.png')}}" alt="contact">
                                </div>
                                <div class="contact-contact">
