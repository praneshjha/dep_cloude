...
@section('title', 'Departure Cloud Demo - Schedule a FREE Demo')
@section('metas')
                            ...
                            <div class="demo-form">
                                <form method="POST" id="demoForm">
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        ...
                                        <img class="inlinecode" src="{{asset('assets1/images/loading.gif') }}" id="gif" style="width: 7%; visibility: hidden;">
