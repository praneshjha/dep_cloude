@extends('layouts.app')
@section('tagSection')
<title>Create Terms Master | Departure Cloud</title>
@endsection
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box mt-3 mb-3 d-flex align-items-center justify-content-between">
                    <h4 class="page-title">Add Terms Master</h4>
                                ...
                                <div class="col-md-11 ml-2">
                                    <div class="form-group">
                                       <label for="email"><br>Terms & Conditions Master:</label>
                                        <textarea class="form-control" name="terms_master" id="terms_master"  placeholder="Write here.."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
