...
<section class="work-section padding-bottom bg_img mb-md-95 pb-md-0 mb-0" data-background="{{asset('website/images/work/work-bg.jpg')}}" id="how" style="background-image: url({{asset('website/images/work/work-bg.jpg')}});padding: 41px 0 !important;">
        <div class="container">
            <div class="thankyou">
                <div class="row align-items-center">
                    <div class="col-md-12 mt-4 mt-md-0 text-center">
                        ...
                        <h3 class="m-0 mb-2">{{ __('Reset Password') }}</h3>
                        
                        <div class="form-group mb-0 text-center mt-3">
                            <form method="POST" action="{{ route('password.update') }}" style="max-width: 410px;margin:0 auto;">
                            @csrf
                                <input type="hidden" name="token" value="{{ $token }}">

                                <div class="form-group mb-3 input-group mb-2">
                                ...
                                <div class="form-group mb-3 input-group mb-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text"><i class="fe-lock"></i></div>
                                    </div>
                                ...
                                <div class="form-group mb-3 input-group mb-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text"><i class="fe-unlock"></i></div>
                                    </div>
                        ...
                        <a class="btn btn-custom w-auto mt-2" href="{{route('login')}}">Back to Login</a>
                    </div>
                </div>
            </div>
        </div>
