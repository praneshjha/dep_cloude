<html lang="en">
    ...
    <body  class="pb-0" style="background-image: url({{asset('website/images/account-bg.jpg')}});background-size: cover;">
            ...
            <div class="d-md-flex  justify-content-between register-box">
                    ...
                    <div class="py-4">
                        <!-- <div class="text-center">
                            <a href="https://www.departurecloud.com" >
                                <img src="{{asset('departure-cloud-logo.png')}}" alt="" height="56">
                            </a>
                        </div> -->
                        <div style="max-width: 550px;" class="text-center mx-auto px-3 px-md-0">
                            <img src="{{asset('login.png')}}" alt="" style="width: 100%;">
                ...
                <div class="register-page px-2 d-flex align-items-center justify-content-center">
                    <div  class="w-100 p-2">
                        ...
                        <p class="departure-signup"><strong>Don't have an account?</strong> <a href="{{route('register')}}" class="ml-1" style="color: #f1bd86;"><b>Sign Up</b></a><span>or</span></p>
                    </div>
                </div>
            </div>
