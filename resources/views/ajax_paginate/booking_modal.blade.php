        ...
        <form role="form" id="BookDepartureForm_{{$departure['id']}}">
            ...
            <div class="bookingMdodal">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-10">
                            <label for="exampleFormControlInput1">Lead Passenger/Agent Name<span id="error_book_msg_{{$departure['id']}}" class="text-danger" style="position: absolute; right: 0%;"></span></label>
